...
class sram_logger(ip_logger):
    def __init__(self, name="sram_logger", parent=None):
        super().__init__(name, parent)
        return
        uvm_fatal("sram_logger", "please write self.header in list format")
...
uvm_component_utils(sram_logger)
